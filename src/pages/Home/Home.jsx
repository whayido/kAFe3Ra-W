...
import circle1 from "../../assets/img/fill/8.gif";
import circle2 from "../../assets/img/fill/6.gif";
...
import NN from "../../assets/img/media/NN.svg";
          ...
          <section id="about" className={style.about}>
            ...
            <div className={style.container_about2}>
              ...
              <div className={style.blok_NN}>
                ...
                <img className={style.partners_icon} src={NN} />
              </div>
