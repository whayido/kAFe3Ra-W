        ...
        <section className={style.about}>
          <div className={cn(style.box, style.courses)}>
            ...
            <div className={style.items}>
              <p className={style.courses_desc}>искусственный интеллект</p>
              <p className={style.courses_desc}>машинное обучение</p>
              <p className={style.courses_desc}>базы данных</p>
              <p className={style.courses_desc}>программирование</p>
            </div>
          </div>
          ...
          <div className={cn(style.box, style.north)}>
            <p className={style.text_about}>
              Передовой центр научных
              <br /> исследований и разработок
              <br /> в области информационных
              <br /> технологий на территории
              <br />
          ...
          <div className={cn(style.box, style.norilsk)}>
            {/* <img src={Norilsk} /> */}
            <div className={style.norilsk_desc}>Норильск</div>
          </div>
